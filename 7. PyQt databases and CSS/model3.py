...
def initializeModel(model):
    ...
    model.EditStrategy.OnManualSubmit
    ...
    model.setHeaderData(0, Qt.Orientations.Horizontal, 'Author name(s)')
    model.setHeaderData(1, Qt.Orientations.Horizontal, 'Book title')
    model.select()    
